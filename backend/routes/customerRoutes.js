...
import { getCustomers, addCustomer, updateCustomer, deleteCustomer, sendManualReminder, getOverdueCustomers, markServiceDone} from '../controllers/customerController.js';
...
router.put("/:id/service-done", markServiceDone);
